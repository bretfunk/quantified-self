  ...
  static fillTable(foods, modelName) {
    foods.reverse().forEach(function(foodType){
      // event.preventDefault
        let button = `<td><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/1c/No-Symbol.png/120px-No-Symbol.png" style="width:15px" class='${modelName}DeleteButton' id='${foodType.id}'></td>`
